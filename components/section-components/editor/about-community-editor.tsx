...
type AboutCommunityFormData = {
  title: TranslatedText;
  description: TranslatedText;
};

interface AboutCommunityEditorProps {
  data: AboutCommunityFormData;
  onDataChange: (data: AboutCommunityFormData) => void;
  sectionId?: string;
}

const AboutCommunityEditor = ({ data, onDataChange, sectionId }: AboutCommunityEditorProps) => {
  const { register, handleSubmit, watch, setValue } = useForm<AboutCommunityFormData>({
    defaultValues: data,
  });
  ...
  const onSubmit = async (values: AboutCommunityFormData) => {
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className={cn(
                      'mt-1',
                      errors[`desc${lang === 'en' ? 'En' : 'Mn'}`] && 'border-red-500'
                    )}
                    placeholder={
                      lang === 'en'
...
export default AboutCommunityEditor;
