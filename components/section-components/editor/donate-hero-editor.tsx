...
type DonateHeroFormData = {
  title: TranslatedText;
  description: TranslatedText;
  image: string;
};

interface DonateHeroEditorProps {
  data: any;
  onDataChange: (updatedData: any) => void;
  sectionId?: string;
}

const DonateHeroEditor = ({ data, onDataChange, sectionId }: DonateHeroEditorProps) => {
  const { register, handleSubmit, watch, setValue, control } = useForm<DonateHeroFormData>({
    defaultValues: data,
  });
  ...
  const onSubmit = async (values: DonateHeroFormData) => {
...
export default DonateHeroEditor;
