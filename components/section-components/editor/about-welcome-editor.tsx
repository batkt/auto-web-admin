...
type AboutWelcomeFormData = {
  title: TranslatedText;
  description: TranslatedText;
};

interface AboutWelcomeEditorProps {
  data: AboutWelcomeFormData;
  onDataChange: (data: AboutWelcomeFormData) => void;
  sectionId?: string;
}

const AboutWelcomeEditor = ({ data, onDataChange, sectionId }: AboutWelcomeEditorProps) => {
  const { register, handleSubmit, watch, setValue } = useForm<AboutWelcomeFormData>({
    defaultValues: data,
  });
  ...
  const onSubmit = async (values: AboutWelcomeFormData) => {
...
export default AboutWelcomeEditor;
