...
type DonateThankYouFormData = {
  title: TranslatedText;
  description: TranslatedText;
};

interface DonateThankYouEditorProps {
  data: any;
  onDataChange: (updatedData: any) => void;
  sectionId?: string;
}

const DonateThankYouEditor = ({ data, onDataChange, sectionId }: DonateThankYouEditorProps) => {
  const { register, handleSubmit, setValue, watch } = useForm<DonateThankYouFormData>({
    defaultValues: data,
  });
  ...
  const onSubmit = async (values: DonateThankYouFormData) => {
...
export default DonateThankYouEditor;
