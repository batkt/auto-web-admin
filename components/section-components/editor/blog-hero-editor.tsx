...
const BlogHeroEditor = ({ data, onDataChange, sectionId }: BlogHeroEditorProps) => {
  const { register, handleSubmit, watch, setValue, control } = useForm<BlogHeroFormData>({
    defaultValues: data,
  });
  ...
  const onSubmit = async (values: BlogHeroFormData) => {
