...
type AboutMissionFormData = {
  title: TranslatedText;
  description: TranslatedText;
};

interface AboutMissionEditorProps {
  data: AboutMissionFormData;
  onDataChange: (data: AboutMissionFormData) => void;
  sectionId?: string;
}

const AboutMissionEditor = ({ data, onDataChange, sectionId }: AboutMissionEditorProps) => {
  const { register, handleSubmit, watch, setValue } = useForm<AboutMissionFormData>({
    defaultValues: data,
  });
  ...
  const onSubmit = async (values: AboutMissionFormData) => {
