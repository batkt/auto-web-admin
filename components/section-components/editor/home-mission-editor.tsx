...
interface HomeMissionEditorProps {
  data: any;
  onDataChange: (updatedData: any) => void;
  sectionId?: string;
}

const HomeMissionEditor = ({ data, onDataChange, sectionId }: HomeMissionEditorProps) => {
  const { register, handleSubmit, watch, setValue } = useForm<MissionFormData>({
    defaultValues: data,
  });
  ...
  const onSubmit = async (values: MissionFormData) => {
